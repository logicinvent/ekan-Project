package com.ekan.ekanproject.application.rest.v1.document.update;
...
public class DocumentUpdateController implements IResourceSaveUpdate<DocumentDto, DocumentDto> {

    private final GenericSaveUseCase<TransferObject<DocumentDto>, DocumentDto> useCase;

    public DocumentUpdateController(GenericSaveUseCase<TransferObject<DocumentDto>, DocumentDto> useCase) {
